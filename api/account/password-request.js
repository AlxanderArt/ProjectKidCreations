// Node runtime — password reset request: stores reset token + Gmail send.
// SMTP latency dominates, so Node 60s. No cookie required (user is locked out),
// but we still forward it harmlessly for parity.
